...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInRequestTag.compose(createDigest.compose(wrapInTransactionTag));
    ...
    interface RequestHandler {
        ...
        default RequestHandler compose(RequestHandler other) {
            //This method returns a new RequestHandler:
            return arg -> this.apply(other.apply(arg));
        }
    }
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(commonRequestHandler.apply(notCompletedRequest).getData());
    }
}
